...
%% represent the flow of goods, is quite common in business mgmt. 
...
\draw[<->, >=latex', shorten >=2pt, shorten <=2pt, bend right=45, thick, dashed] (retailer1.south) to node[auto, swap] {Competition}(retailer2.south); 
