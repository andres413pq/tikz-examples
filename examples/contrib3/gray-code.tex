% Gray Code in 4-cube
% (depicts a Gray code traversing all the nodes of a 4-dimensional hypercube.)
% Tags: combinatorics, Gray code, hypercube, graph, cyclic path
% Author: Yury Chebiryak.
% See http://yury.chebiryak.name/hypercubes.htm for more details.
