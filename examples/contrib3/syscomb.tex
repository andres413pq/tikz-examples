...
:Tags: Block diagrams, speech recognition, Layers
:Author: Harish K Krishnamurthy
:Home: www.ece.neu.edu/~hkashyap/
...
\fill (bwtn.east)+(\x,0) circle (0.1cm); 
    ...
    \end{pgfonlayer}
        ...
        \path (asr1-2.south) +(-\blockdist,-\blockdist) node (asrs) {System Combination - Validation};
